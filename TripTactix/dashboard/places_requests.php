...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Tourism Places Requests</h1>
            </div>
        </div><!--/.row-->
        ...
        <?php
            header('refresh:4,url=places_requests.php');
            ob_end_flush();
        }
        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class=" action-buttons">
                                    <a href="functions/delete_places_requests.php?id=<?php echo $row['id']; ?>" class="trash">
                                        <em class="fa fa-trash"></em>
                                    </a>
                                </div>
                                <div class="action-buttons">
                                    <a href="functions/update_place_request.php?id=<?php echo $row['id']; ?>" class="trash">

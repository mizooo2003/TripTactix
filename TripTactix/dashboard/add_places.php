...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        ?>
            ...
            <div class="alert bg-success" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>A New Place Was Added Successfully</div>

        <?php
            header('refresh:4,url=add_program.php');
            ob_end_flush();
        }
        ?>
                ...
                <div class="col-md-offset-1 col-sm-10">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" method="post" action="functions/add_place_func.php" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Place Title" name="title" type="text" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Direction URL"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="desc" rows="5" cols="50" style="white-space:pre;">
                                            </textarea>
                                    </div>



                                    <input type="submit" name="add" class="btn btn-primary pull-right" value="Add Place">
                                </fieldset>
                            </form>

...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">ALL Tour Guides</h1>
            </div>
        </div><!--/.row-->
        ...
        ?>
            ...
            <div class="alert bg-success" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>Tour Guide Was Deleted Successfully</div>

        <?php
            header('refresh:4,url=tour_guides.php');
            ob_end_flush();
        }
        ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class=" action-buttons">
                                    <a href="functions/delete_tour_guides.php?id=<?php echo $row['id']; ?>" class="trash">
